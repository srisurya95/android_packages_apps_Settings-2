...
import android.media.MP4Header;
import android.media.WAVHeader;
...
public class SoundFile {
    ...
    public void WriteFile(File outputFile, float startTime, float endTime)
        ...
        try {
            ...
            Log.e("Settings", "Failed to create the .m4a file.");
    ...
    private void DumpSamples(String fileName) {
        ...
        try {
            ...
            Log.w("Settings", "Failed to create the sample TSV file.");
            Log.w("Settings", getStackTrace(e));
        }
        // We are done here. Close the file and rewind the buffer.
        try {
            writer.close();
        } catch (Exception e) {
            Log.w("Settings", "Failed to close sample TSV file.");
            Log.w("Settings", getStackTrace(e));
        }
        mDecodedSamples.rewind();
    }
